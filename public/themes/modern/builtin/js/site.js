...
jQuery(document).ready(function () {
	...
	$('#mobile-menu-btn').click(function(){
		...
		// tambahan eko untuk otomatis lebar datagrid easyui
		if($('#dg').length){
			// alert("DG  exists");
		       	$('#dg').datagrid();
		    }
		 ...
		 if($('#dgpanel').length){
			// alert("DG  exists");
		       	$('#dgpanel').layout('resize');
		    }
		//batas tambahan eko untuk otomatis lebar datagrid easyui
	...
	// dimatikan tanggal 9 nov 2022
	//$('.sidebar').overlayScrollbars({scrollbars : {autoHide: 'leave', autoHideDelay: 100} });
	OverlayScrollbars(document.querySelector(".sidebar"), { scrollbars: { autoHide: "scroll", autoHideDelay: 100 } });
