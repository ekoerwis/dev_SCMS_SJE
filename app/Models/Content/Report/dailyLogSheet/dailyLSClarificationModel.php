...
class dailyLSClarificationModel extends \App\Models\BaseModel
{
    ...
    public function reportSqlString($tdate='',$tdate_end='' ,$id=''){
        ...
        OSS1, VERMD1, USRMD1, COTTMP1 FROM POM_LGS_CLR WHERE POSTDT BETWEEN  TO_DATE('$tdate','dd/mon/yyyy') AND TO_DATE('$tdate_end','dd/mon/yyyy') ORDER BY POSTDT, SEQ
        ";
