...
class dailyLSSterilizerModel extends \App\Models\BaseModel
{
    ...
    public function reportSqlString($tdate='' ,$tdate_end='' ,$dt_div=''){
...
SELECT LGSID, UEP,
        ...
        STZACC, STZNOTE, STP1,STP2,STP3,STP4,STP5, STZTMP1, STZBAF1, STZSTMPV1 FROM POM_LGS_STZ WHERE  ROWNUM > 0  $w_tdate $w_dt_div
        ";
    ...
    public function dataList()
    {
        ...
        $sqlReport = $this->reportSqlString($TDATE,$TDATE_END, $DT_DIV );
    ...
    $sql = "SELECT count(*) AS JUMLAH FROM 
        ...
        $sql = "SELECT * FROM (SELECT LGSID, UEP, TDATE_UEP_DATEF, TDATE_UEP, COMP_ID, SITE_ID, POSTDT, STZID, STZIN_ST, STZIN_ST_TIME, STZIN_ED, STZIN_ED_TIME, STZIN_MN, STZWS_ST, STZWS_ST_TIME, STZWS_ED, STZWS_ED_TIME, STZWS_MN, STZPRO_ST, STZPRO_ST_TIME, STZPRO_ED, STZPRO_ED_TIME, STZPRO_MN, STZWO_ST, STZWO_ST_TIME, STZWO_ED, STZWO_ED_TIME, STZWO_MN, STZOUT_ST, STZOUT_ST_TIME, STZOUT_ED, STZOUT_ED_TIME, STZOUT_MN, STZTM_TOT, STZACC, STZNOTE, STP1, STP2, STP3, STP4, STP5, STZTMP1, STZBAF1, STZSTMPV1, ROWNUM AS RNUM FROM ( $mainSql ORDER BY $sort $order) WHERE ROWNUM <= $limit) WHERE RNUM > $offset";
