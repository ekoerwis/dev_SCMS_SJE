...
class dailyLSThresherModel extends \App\Models\BaseModel
{
    ...
    public function reportSqlString($tdate='',$tdate_end='' ,$id=''){
        ...
        FROM POM_LGS_THR WHERE POSTDT BETWEEN TO_DATE('$tdate','dd/mon/yyyy')  AND  TO_DATE('$tdate_end','dd/mon/yyyy')   ORDER BY POSTDT, SEQ
        ";
