...
class dailyLSKernelModel extends \App\Models\BaseModel
{
    ...
    public function reportSqlString($tdate='',$tdate_end='' ,$id=''){
        ...
        KERHDS_L1ACT, KERHDS_L2ACT, 
        KERHDS_L11ACT, KERHDS_L12ACT, KERHDS_L13ACT, 
        KERHDS_L21ACT, KERHDS_L22ACT, KERHDS_L23ACT, 
        KERHDS_HMS11, KERHDS_HMS12, KERHDS_HMS13,
        KERHDS_HMS21, KERHDS_HMS22, KERHDS_HMS23, 
        KERHDS_HME11, KERHDS_HME12, KERHDS_HME13, 
        KERHDS_HME21, KERHDS_HME22, KERHDS_HME23, 
        ...
        KERBAS_S1, KERBAS_E1, KERRPM_HMS1, KERRPM_HMS2, KERRPM_HMS3, KERRPM_HMS4, KERRPM_HMS5, KERRPM_HMS6, KERRPM_HMS7, KERRPM_HMS8, 
        KERRPM_HME1, KERRPM_HME2, KERRPM_HME3, KERRPM_HME4, KERRPM_HME5, KERRPM_HME6, KERRPM_HME7, KERRPM_HME8, KERAPP_DT, KERAPP_BY, KERNOTE, '' HDCAWAL, '' HDCAKHIR
        FROM POM_LGS_KER 
        WHERE POSTDT BETWEEN TO_DATE('$tdate','dd/mon/yyyy') AND TO_DATE('$tdate_end','dd/mon/yyyy')
        ORDER BY POSTDT,SEQ
        ";
    ...
    public function dataList()
    {
        ...
        $sort = isset($_POST['sort']) ? strval($_POST['sort']) : 'POSTDT,SEQ';
        ...
        $sqlReport = $this->reportSqlString($TDATE,$TDATE_END);
