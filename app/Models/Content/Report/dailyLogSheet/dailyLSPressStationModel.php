...
class dailyLSPressStationModel extends \App\Models\BaseModel
{
    ...
    public function reportSqlString($tdate='',$tdate_end=''  ,$id=''){
        ...
        PRSDG_HME1, PRSDG_HME2, PRSDG_HME3, PRSDG_HME4, PRSDG_HME5, PRSDG_HME6, 
        PRSSP_HME1, PRSSP_HME2, PRSSP_HME3, PRSSP_HME4, PRSSP_HME5, PRSSP_HME6, 
        ...
        FROM POM_LGS_PRS WHERE POSTDT BETWEEN TO_DATE('$tdate','dd/mon/yyyy') AND TO_DATE('$tdate_end','dd/mon/yyyy') ORDER BY POSTDT, SEQ";
    ...
    $sql = "SELECT count(*) AS JUMLAH FROM 
        ...
        PRSDG_HME1, PRSDG_HME2, PRSDG_HME3, PRSDG_HME4, PRSDG_HME5, PRSDG_HME6, 
        PRSSP_HME1, PRSSP_HME2, PRSSP_HME3, PRSSP_HME4, PRSSP_HME5, PRSSP_HME6, 
        PRSCB_HMS1, PRSCB_HMS2, PRSCB_HMS3, 
        PRSCB_HME1, PRSCB_HME2, PRSCB_HME3, 
        PRSCB_HMP1, PRSCB_HMP2, PRSCB_HMP3, 
        PRSCB_SRT1, PRSCB_SRT2, PRSCB_SRT3, 
        PRSCB_END1, PRSCB_END2, PRSCB_END3, 
    ...
    {   
        ...
        $sqlReport = $this->reportSqlString($TDATE, $TDATE_END , $STG_ID);
