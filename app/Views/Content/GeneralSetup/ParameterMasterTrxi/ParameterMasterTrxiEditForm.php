...
<form id="fm" method="post" novalidate>
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-sm-7">
                    <div class="row col-sm-12 divbottom">
                        ...
                        <div class="col-sm-9">
                            <input name="PARAMETERCODE" class="easyui-textbox col-sm-4" data-options="required:true, readonly:true" prompt="Parameter Code" value="<?=set_value('PARAMETERCODE', @$PARAMETERCODE)?>"></input>
                            <input name="PARAMETERNAME" class="easyui-textbox col-sm-7" data-options="required:true"
                                prompt="Parameter Name" value="<?=set_value('PARAMETERNAME', @$PARAMETERNAME)?>"></input>
                        </div>
                    </div>
                    ...
                    <div class="row col-sm-12 divbottom">
                        ...
                        <div class="col-sm-9">
                            <input name="CONTROLSYSTEM" class="easyui-textbox col-sm-4" data-options="required:true"
                                prompt="Control System"  value="<?=set_value('CONTROLSYSTEM', @$CONTROLSYSTEM)?>"></input>
                        </div>
                    </div>
                    ...
                    <div class="row col-sm-12 divbottom" hidden>
                        ...
                        <div class="col-sm-9">
                            <input id="cg-uom" name="UOM" class="easyui-combogrid col-sm-4"
                                data-options="required:false" prompt="UOM / Satuan"  value="<?=set_value('UOM', @$UOM)?>"></input>
                            <input id="tb-uomdesc" name="UOMDESC" class="easyui-textbox col-sm-7"
                                data-options="required:false, readonly:true" prompt="UOM Desc"  value="<?=set_value('UOMDESC', @$UOMDESC)?>"></input>
                        </div>
                    ...
                    <div class="row col-sm-12 divbottom">
                        ...
                        <div class="col-sm-9">
                            <input id="checkInactive" type="checkbox" <?php if(@$INACTIVE == '1') echo "checked = 'checked'" ?> >&nbsp;
                            <input id="ChangeInactive" name="INACTIVE" type="textbox" value="<?php if($INACTIVE == '1') {echo '1';}else{ echo '0';} ?>" hidden>
                            <input id="checkDate" name="INACTIVEDATE" class="easyui-textbox col-sm-6"
                                data-options="readonly:true" value="<?=set_value('INACTIVEDATE', @$INACTIVEDATE)?>"></input>
    ...
    <div data-options="region:'center',split:true" title="">
        <table id="dg" title="&nbsp;Parameter Detail "
            style="width:100%;<?php echo $tinggi_dg_6; ?>" data-options="footer:'#ft'">
        </table>
...
$(function() {
  $('#dg').edatagrid({
    url:"<?php echo site_url() . '/../content/GeneralSetup/ParameterMasterTrxi/getDetailByIdForm?id='.$PARAMETERCODE; ?>",
    // iconCls:'icon-edit',
    singleSelect: true,
    fitColumns: false,
    rownumbers: true,
...
<script type="text/javascript">
    function saveData() {
        $('#fm').form('submit', {
            url: '<?php echo site_url() . '/../content/GeneralSetup/ParameterMasterTrxi/updateData'; ?>',
      onSubmit: function() {
