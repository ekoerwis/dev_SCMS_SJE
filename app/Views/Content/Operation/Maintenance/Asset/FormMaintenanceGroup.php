...
$('#group-facode').combogrid({
  panelWidth: 500,
  url: "<?php echo site_url().'/../content/operation/maintenance/asset/getFaGroup'; ?>",
  idField:'GROUPID',
  textField:'GROUPID',
  mode:'remote',
  loadMsg: 'Loading',
...
<script type="text/javascript">
  function saveMaintenanceGroup() {
    $('#fm-maintenancegroup').form('submit', {
      url: "<?php echo site_url().'/../content/operation/maintenance/asset/saveMaintenanceGroup'; ?>",
      onSubmit:function(){
...
<script type="text/javascript">
  function updateMaintenanceGroup() {
    $('#fm-maintenancegroup').form('submit', {
      url: "<?php echo site_url().'/../content/operation/maintenance/asset/updateMaintenanceGroup'; ?>",
      onSubmit:function(){
        var valid =  $(this).form('validate');
        if (valid){
          loadingBar('on');
