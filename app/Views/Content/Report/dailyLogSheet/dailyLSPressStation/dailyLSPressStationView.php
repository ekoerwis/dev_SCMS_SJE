<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSPressStation/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //     required:true,
            //     value:"1",
            //     url: "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSPressStation/getPress'; ?>",
            // });
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSPressStation/exportExcelFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
            // var url = "<?php  //echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSPressStation/exportExcelFile?TDATE='; ?>"+dateParam+"&PRSID="+idParam;
        ...
        function exportDataPDF() {
            ...
            if( dateEndParam.trim() == '' || dateEndParam.trim() == null ){
             ...
             var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSPressStation/exportPDFFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
            // var url = "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSPressStation/cekPdfView?TDATE='; ?>"+dateParam+"&PRSID="+idParam;
            window.open(url, "_blank");
    }
