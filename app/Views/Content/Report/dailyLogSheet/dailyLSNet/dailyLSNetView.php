<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSNet/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#cb-dt_div').combobox({
                url: "<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSNet/getNetAdd'; ?>",
                required:false,
                loadMsg: 'Loading',
                panelHeight:'auto',
                valueField:'NETADD',
        ...
        function exportDataExcel() {
            ...
            // var url = "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSNet/exportExcelFile?TDATE='; ?>"+dateParam+"&DT_DIV="+dtDivParam+"&ST_HR="+ST_HR+"&END_HR="+END_HR;
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSNet/exportExcelFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
            // +"&DT_DIV="+dtDivParam+"&ST_HR="+ST_HR+"&END_HR="+END_HR;
        ...
        function exportDataPDF() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSNet/exportPDFFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
            // +"&DT_DIV="+dtDivParam+"&ST_HR="+ST_HR+"&END_HR="+END_HR;
            // var url = "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSNet/exportPDFFile?TDATE='; ?>"+dateParam+"&DT_DIV="+dtDivParam+"&ST_HR="+ST_HR+"&END_HR="+END_HR;
            window.open(url, "_blank");
        }
