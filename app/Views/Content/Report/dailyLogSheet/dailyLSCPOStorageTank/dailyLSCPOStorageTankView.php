<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSCPOStorageTank/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
        ...
        <thead>
            <tr>
                <th rowspan="3" field="POSTDT"halign="center" data-options="sortable:false,width:60,align:'center' " formatter=""><b>TANGGAL</b></th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#cb-stg_id').combobox({
                ...
                prompt:"Storage ID",
                required:true,
                url: "<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSCPOStorageTank/getStg'; ?>",
            });
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSCPOStorageTank/exportExcelFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam+"&STG_ID="+stgIdParam;
        ...
        function exportDataPDF() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSCPOStorageTank/exportPDFFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam+"&STG_ID="+stgIdParam;
            // var url = "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSCPOStorageTank/cekPdfView?TDATE='; ?>"+dateParam+"&STG_ID="+stgIdParam;
            window.open(url, "_blank");
    }
