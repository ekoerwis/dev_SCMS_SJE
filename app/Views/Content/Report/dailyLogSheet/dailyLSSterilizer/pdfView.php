    ...
    <table id="dataTable" class="table1">
        <thead>
            <tr class="trHeadTable1">
                ...
                <th class="thTable1" rowspan=2  style="border: 1px solid black;border-collapse: collapse;text-align: center; font-size: 7pt;" width="90px">Tanggal</th>
                ...
                <th class="thTable1" rowspan=2  style="border: 1px solid black;border-collapse: collapse;text-align: center; font-size: 7pt;" width="50px">STEAM</th>
                <th class="thTable1" rowspan=2  style="border: 1px solid black;border-collapse: collapse;text-align: center; font-size: 7pt;" width="50px">TEMP AUTOFEED (<span>&#176;</span>C)</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tdTable1" style="text-align: right;border-collapse: collapse; border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;"><?= $data_sql[$i]['STZSTMPV1'] ?></td>
                <td class="tdTable1" style="text-align: right;border-collapse: collapse; border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;"><?= $data_sql[$i]['STZBAF1'] ?></td>
