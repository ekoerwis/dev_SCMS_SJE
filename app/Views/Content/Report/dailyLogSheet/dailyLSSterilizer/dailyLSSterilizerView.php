<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSSterilizer/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
        ...
        <thead>
            <tr>
                <th field="POSTDT" halign="center" data-options="sortable:false,width:100,align:'center' " formatter="" rowspan="2"><b>Tanggal</b></th>
                <th field="STZID" halign="center" data-options="sortable:false,width:80,align:'center' " formatter="" rowspan="2"><b>Sterilizer</b></th>
    ...
    <script type="text/javascript">
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSSterilizer/exportExcelFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam+"&DT_DIV="+dtDivParam;
        ...
        function exportDataPDF() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSSterilizer/exportPDFFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam+"&DT_DIV="+dtDivParam;
            window.open(url, "_blank");
    }
