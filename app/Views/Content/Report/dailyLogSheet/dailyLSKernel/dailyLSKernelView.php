<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSKernel/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
    ...
    <script type="text/javascript">
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSKernel/exportExcelFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
        ...
        function exportDataPDF() {
            ...
            if( dateEndParam.trim() == '' || dateEndParam.trim() == null ){
             ...
             var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSKernel/exportPDFFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
            window.open(url, "_blank");
    }
