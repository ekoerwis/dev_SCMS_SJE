<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSBoiler/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
                    ...
                    rownumbers: true,
                    frozenColumns:[[
                        {field:'POSTDT',title:'JAM',width:100,align:'center'},
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#cb-stationid').combobox({
                ...
                required:true,
                value:"1",
                url: "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSBoiler/getStationID'; ?>",
            });
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSBoiler/exportExcelFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam+"&STATIONID="+idParam;
        ...
        function exportDataPDF() {
            ...
            if( idParam.trim() == '' || idParam.trim() == null ){
             ...
             var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSBoiler/exportPDFFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam+"&STATIONID="+idParam;
            // var url = "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSBoiler/cekPdfView?TDATE='; ?>"+dateParam+"&STATIONID="+idParam;
            window.open(url, "_blank");
    }
