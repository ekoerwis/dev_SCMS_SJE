<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSThresher/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //     required:true,
            //     value:"1",
            //     url: "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSThresher/getStationID'; ?>",
            // });
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSThresher/exportExcelFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
        ...
        function exportDataPDF() {
            ...
            if( dateEndParam.trim() == '' || dateEndParam.trim() == null ){
             ...
             var url = "<?php  echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSThresher/exportPDFFile?TDATE='; ?>"+dateParam+"&TDATE_END="+dateEndParam;
            // var url = "<?php // echo site_url() . '/../Content/Report/dailyLogSheet/dailyLSThresher/cekPdfView?TDATE='; ?>"+dateParam+"&STATIONID="+idParam;
            window.open(url, "_blank");
    }
