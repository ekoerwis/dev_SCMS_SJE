<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/LogSheet/logSheetPowerhouseTurbin/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#cb-stationid').combobox({
                ...
                required:true,
                value:"1",
                url: "<?php  echo site_url() . '/../Content/LogSheet/logSheetPowerhouseTurbin/getStationID'; ?>",
            });
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/LogSheet/logSheetPowerhouseTurbin/exportExcelFile?TDATE='; ?>"+dateParam+"&STATIONID="+idParam;
