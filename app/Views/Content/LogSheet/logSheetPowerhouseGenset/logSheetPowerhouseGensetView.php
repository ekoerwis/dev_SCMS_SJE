<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/LogSheet/logSheetPowerhouseGenset/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
    ...
    <script type="text/javascript">
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/LogSheet/logSheetPowerhouseGenset/exportExcelFile?TDATE='; ?>"+dateParam+"&STATIONID="+idParam;
        ...
        function exportDataPDF() {
            ...
            if( idParam.trim() == '' || idParam.trim() == null ){
             ...
             var url = "<?php  echo site_url() . '/../Content/LogSheet/logSheetPowerhouseGenset/exportPDFFile?TDATE='; ?>"+dateParam+"&STATIONID="+idParam;
            // var url = "<?php // echo site_url() . '/../Content/LogSheet/logSheetPowerhouseGenset/cekPdfView?TDATE='; ?>"+dateParam+"&STATIONID="+idParam;
            window.open(url, "_blank");
    }
