...
// use App\Models\Content\LiveMonitoring\SterilizerStationModel;
use \Config\App;
...
class SterilizerStation extends \App\Controllers\BaseController
{
    public $SterilizerStationModel;

	public function __construct() {

		parent::__construct();
		
		// $this->SterilizerStationModel = new SterilizerStationModel;
