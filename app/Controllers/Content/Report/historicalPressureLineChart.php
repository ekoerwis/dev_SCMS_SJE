...
use App\Models\Content\Report\historicalPressureLineChartModel;
use \Config\App;
...
class historicalPressureLineChart extends \App\Controllers\BaseController
{
    public $historicalPressureLineChartModel;

	public function __construct() {

		parent::__construct();
		
		$this->historicalPressureLineChartModel = new historicalPressureLineChartModel;

		$this->data['site_title'] = 'Historical Pressure Line Chart ';
	...
	public function index(){
        ...
        $data['dataGraph']=$this->historicalPressureLineChartModel->dataGraph();

		$this->view('Content/Report/historicalPressureLineChart/historicalPressureLineChartView.php', $data);
	}

    public function getData(){
		$this->cekHakAkses('READ_DATA');
		
        echo json_encode($this->historicalPressureLineChartModel->dataGraph());
	...
	public function getDataBpv(){
        ...
        echo json_encode($this->historicalPressureLineChartModel->getDataBpv());
	...
	public function getDataTurbin(){
        ...
        echo json_encode($this->historicalPressureLineChartModel->getDataTurbin());
