...
use App\Models\Content\Report\dailyLogSheet\dailyLSPowerhouseGensetModel;
use \Config\App;
...
class dailyLSPowerhouseGenset extends \App\Controllers\BaseController
{
    public $dailyLSPowerhouseGensetModel;

	public function __construct() {

		parent::__construct();
		
		$this->dailyLSPowerhouseGensetModel = new dailyLSPowerhouseGensetModel;

		$this->data['site_title'] = 'LogSheet Power House Genset ';
	...
	public function index(){
		...
		$this->view('Content/Report/dailyLogSheet/dailyLSPowerhouseGenset/dailyLSPowerhouseGensetView.php', $data);
	}

    public function getStationID(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSPowerhouseGensetModel->getStationID());     
    }

    public function dataList(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSPowerhouseGensetModel->dataList());        
	}
    ...
    public function cekDataexportExcelFile(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSPowerhouseGensetModel->dataListExcel());        
	}
    ...
    public function exportPDFFile()
    {
        ...
        $titleOrg =$this->dailyLSPowerhouseGensetModel->getSCD_MA_PARAM('ORG','ORGPRN')[0]['VALSTR'];
        $titleSite =$this->dailyLSPowerhouseGensetModel->getSCD_MA_PARAM('ORG','ORGSITELONG')[0]['VALSTR'];

		$data['Judul'] = 'Laporan '.$this->data['site_title'];
		$data['data_sql'] = $this->dailyLSPowerhouseGensetModel->dataListExcel();
        ...
        <tr>
            ...
            <td style="width:33.33%; text-align:center;">  
                POWERHOUSE GENSET STATION<br>DAILY LOGSHEET
            </td>
        ...
        $html = view('Content/Report/dailyLogSheet/dailyLSPowerhouseGenset/pdfView.php', $data);
        $mpdf->WriteHTML($html);
	...
	public function cekPdfView(){
		...
		echo view('Content/Report/dailyLogSheet/dailyLSPowerhouseGenset/pdfView.php', $data);
