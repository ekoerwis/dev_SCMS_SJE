...
use App\Models\Content\Report\dailyLogSheet\dailyLSPowerhouseTurbinModel;
use \Config\App;
...
class dailyLSPowerhouseTurbin extends \App\Controllers\BaseController
{
    public $dailyLSPowerhouseTurbinModel;

	public function __construct() {

		parent::__construct();
		
		$this->dailyLSPowerhouseTurbinModel = new dailyLSPowerhouseTurbinModel;
	...
	public function index(){
		...
		$this->view('Content/Report/dailyLogSheet/dailyLSPowerhouseTurbin/dailyLSPowerhouseTurbinView.php', $data);
	}

    public function getStationID(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSPowerhouseTurbinModel->getStationID());     
    }

    public function dataList(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSPowerhouseTurbinModel->dataList());        
	}
    ...
    public function cekDataexportExcelFile(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSPowerhouseTurbinModel->dataListExcel());        
	}
    ...
    public function exportPDFFile()
    {
        ...
        $titleOrg =$this->dailyLSPowerhouseTurbinModel->getSCD_MA_PARAM('ORG','ORGPRN')[0]['VALSTR'];
        $titleSite =$this->dailyLSPowerhouseTurbinModel->getSCD_MA_PARAM('ORG','ORGSITELONG')[0]['VALSTR'];

		$data['Judul'] = 'Laporan '.$this->data['site_title'];
		$data['data_sql'] = $this->dailyLSPowerhouseTurbinModel->dataListExcel();
        ...
        <tr>
            ...
            <td style="width:33.33%; text-align:center;">  
                POWERHOUSE TURBIN STATION <br> DAILY LOGSHEET
            </td>
        ...
        $html = view('Content/Report/dailyLogSheet/dailyLSPowerhouseTurbin/pdfView.php', $data);
        $mpdf->WriteHTML($html);
	...
	public function cekPdfView(){
		...
		echo view('Content/Report/dailyLogSheet/dailyLSPowerhouseTurbin/pdfView.php', $data);
