...
use App\Models\Content\Report\dailyLogSheet\dailyLSBoilerModel;
use \Config\App;
...
class dailyLSBoiler extends \App\Controllers\BaseController
{
    public $dailyLSBoilerModel;

	public function __construct() {

		parent::__construct();
		
		$this->dailyLSBoilerModel = new dailyLSBoilerModel;
	...
	public function index(){
		...
		$this->view('Content/Report/dailyLogSheet/dailyLSBoiler/dailyLSBoilerView.php', $data);
	}

    public function getStationID(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSBoilerModel->getStationID());     
    }

    public function dataList(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSBoilerModel->dataList());        
	}
    ...
    public function cekDataexportExcelFile(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSBoilerModel->dataListExcel());        
	}
    ...
    public function exportPDFFile()
    {
		...
		$data['data_sql'] = $this->dailyLSBoilerModel->dataListExcel();
        ...
        $titleOrg =$this->dailyLSBoilerModel->getSCD_MA_PARAM('ORG','ORGPRN')[0]['VALSTR'];
        $titleSite =$this->dailyLSBoilerModel->getSCD_MA_PARAM('ORG','ORGSITELONG')[0]['VALSTR'];
        ...
        <tr>
            ...
            <td style="width:33.33%; text-align:center;">  
                BOILER STATION <br> DAILY LOGSHEET
            </td>
        ...
        $html = view('Content/Report/dailyLogSheet/dailyLSBoiler/pdfView.php', $data);
        $mpdf->WriteHTML($html);
	...
	public function cekPdfView(){
		...
		echo view('Content/Report/dailyLogSheet/dailyLSBoiler/pdfView.php', $data);
