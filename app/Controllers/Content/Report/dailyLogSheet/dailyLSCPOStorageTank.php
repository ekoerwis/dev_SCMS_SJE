...
use App\Models\Content\Report\dailyLogSheet\dailyLSCPOStorageTankModel;
use \Config\App;
...
class dailyLSCPOStorageTank extends \App\Controllers\BaseController
{
    public $dailyLSCPOStorageTankModel;

	public function __construct() {

		parent::__construct();
		
		$this->dailyLSCPOStorageTankModel = new dailyLSCPOStorageTankModel;
	...
	public function index(){
		...
		$this->view('Content/Report/dailyLogSheet/dailyLSCPOStorageTank/dailyLSCPOStorageTankView.php', $data);
	}

    public function getStg(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSCPOStorageTankModel->getStg());     
    }

    public function dataList(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSCPOStorageTankModel->dataList());        
	}
    ...
    public function cekDataexportExcelFile(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->dailyLSCPOStorageTankModel->dataListExcel());        
	}
	...
	public function exportExcelFile()
    {
        $this->cekHakAkses('READ_DATA');
        $data = $this->data;
        $data_parameter = $this->dailyLSCPOStorageTankModel->dataListExcel();
        ...
        $titleOrg =$this->dailyLSCPOStorageTankModel->getSCD_MA_PARAM('ORG','ORGPRN')[0]['VALSTR'];
        $titleSite =$this->dailyLSCPOStorageTankModel->getSCD_MA_PARAM('ORG','ORGSITELONG')[0]['VALSTR'];
        

        $fileName = 'writable/filedownload/dailyLSCPOStorageTank_'.$userid.'.xlsx';
    ...
    public function exportPDFFile()
    {
		...
		$data['data_sql'] = $this->dailyLSCPOStorageTankModel->dataListExcel();
        ...
        $html = view('Content/Report/dailyLogSheet/dailyLSCPOStorageTank/pdfView.php', $data);
        $mpdf->WriteHTML($html);
	...
	public function cekPdfView(){
		...
		echo view('Content/Report/dailyLogSheet/dailyLSCPOStorageTank/pdfView.php', $data);
	}
