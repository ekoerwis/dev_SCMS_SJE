...
use App\Models\Content\LogSheet\logSheetBoilerModel;
use \Config\App;
...
class logSheetBoiler extends \App\Controllers\BaseController
{
    public $logSheetBoilerModel;
	...
	public function index(){
		...
		$this->view('Content/LogSheet/logSheetBoiler/logSheetBoilerView.php', $data);
	}

    public function getStationID(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->logSheetBoilerModel->getStationID());     
    }

    public function dataList(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->logSheetBoilerModel->dataList());        
	}
    ...
    public function cekDataexportExcelFile(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->logSheetBoilerModel->dataListExcel());        
	}
    ...
    public function exportPDFFile()
    {
        ...
        $html = view('Content/LogSheet/logSheetBoiler/pdfView.php', $data);
        $mpdf->WriteHTML($html);
	...
	public function cekPdfView(){
		...
		echo view('Content/LogSheet/logSheetBoiler/pdfView.php', $data);
