...
use App\Models\Content\LogSheet\logSheetThresherModel;
use \Config\App;
...
class logSheetThresher extends \App\Controllers\BaseController
{
    public $logSheetThresherModel;
	...
	public function index(){
		...
		$this->view('Content/LogSheet/logSheetThresher/logSheetThresherView.php', $data);
	}

    public function getStationID(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->logSheetThresherModel->getStationID());     
    }

    public function dataList(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->logSheetThresherModel->dataList());        
	}
    ...
    public function cekDataexportExcelFile(){
        $this->cekHakAkses('READ_DATA');
		echo json_encode($this->logSheetThresherModel->dataListExcel());        
	}
    ...
    public function exportPDFFile()
    {
        ...
        <tr>
            ...
            <td style="width:33.33%; text-align:center;">  
                THRESHER & EMPTY BUNCH PRESS STATION
            </td>
        ...
        $html = view('Content/LogSheet/logSheetThresher/pdfView.php', $data);
        $mpdf->WriteHTML($html);
	...
	public function cekPdfView(){
		...
		echo view('Content/LogSheet/logSheetThresher/pdfView.php', $data);
