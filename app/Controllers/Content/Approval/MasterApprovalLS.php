...
use App\Models\Content\Approval\MasterApprovalLSModel;
use \Config\App;
...
class MasterApprovalLS extends \App\Controllers\BaseController
{
    public $MasterApprovalLSModel;

	public function __construct() {

		parent::__construct();
		
		$this->MasterApprovalLSModel = new MasterApprovalLSModel;
	...
	public function index(){
		...
		$this->view('Content/Approval/MasterApprovalLS/MasterApprovalLSListView.php', $data);
    ...
    public function dataList(){
		...
		echo json_encode($this->MasterApprovalLSModel->dataList());        
	}
	...
	public function addForm()
	{
		...
		$this->view('Content/Approval/MasterApprovalLS/MasterApprovalLSAddForm.php', $data);
	}
	...
	{
		$this->cekHakAkses('CREATE_DATA');
		$action = $this->MasterApprovalLSModel->saveData($this->user);
	...
	public function deleteData()
	{
		...
		echo json_encode($this->MasterApprovalLSModel->deleteData());
	}
