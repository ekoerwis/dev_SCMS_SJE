...
class Base extends Controller
{
	...
	{ 
		...
		$this->data['scripts'] = array($this->config->baseURL . '/public/assets/vendors/jquery/jquery.min.js?r='.time()
										, $this->config->baseURL . '/public/assets/vendors/flatpickr/flatpickr.js?r='.time()
										, $this->config->baseURL . '/public/themes/modern/assets/js/site.js?r='.time()
										, $this->config->baseURL . '/public/assets/vendors/zenscroll/zenscroll-min.js?r='.time()
										, $this->config->baseURL . '/public/assets/vendors/bootstrap/js/bootstrap.js?r='.time()
								);
		$this->data['styles'] = array(
									$this->config->baseURL . '/public/assets/vendors/bootstrap/css/bootstrap.css?r='.time()
